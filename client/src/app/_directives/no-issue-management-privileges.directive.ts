...
@Directive({
  selector: '[appNoIssueManagementPrivileges]'
})
export class NoIssueManagementPrivilegesDirective {
  user: User;
  ...
  constructor(private viewContainerRef: ViewContainerRef,
    ...
    //   },
    //   complete: () => {
    //     if(this.user?.roles.every(r => !this.issueManagementRoles.includes(r))){
